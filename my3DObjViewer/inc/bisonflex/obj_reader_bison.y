...
%token O V VT VN S F G MTLLIB USEMTL ON OFF
...
| objects object 				{ yylog("object objects has been reducted.\n"); }
;
...
| group                                         { yylog("group has been attached.\n"); }
;
...
group:      G NAME                              { yylog("g groupname will be ignored.\n"); }
;
...
;
attribute_mapKd:  MAP_KD NAME	 		{ yylog("attribute_mapKd has been reducted.\n" ); $$ = createAttributeMapKd( $2 ); }
;
